...
Recommendation.create!(recommendee_id: user1.id, recommender_id: user4.id, tmdb_id: 100088, media_type: 'tv', created_at: Time.zone.now + 3.minutes, updated_at: Time.zone.now + 3.minute)
...
Recommendation.create!(recommendee_id: user5.id, recommender_id: user4.id, tmdb_id: 100088, media_type: 'tv', created_at: Time.zone.now + 5.minutes, updated_at: Time.zone.now + 5.minute)
